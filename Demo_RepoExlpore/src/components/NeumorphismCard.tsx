...
export function NeumorphismCard({ repo, onClose }: NeumorphismCardProps) {
  ...
  return (
    <div 
      className={`w-[380px] bg-[#202125] rounded-[30px] p-[30px] shadow-[15px_15px_30px_rgba(0,0,0,0.4),-10px_-10px_20px_rgba(255,255,255,0.04)] font-sans text-white cursor-pointer transition-all duration-[400ms] select-none relative hover:-translate-y-[5px] ${repo ? 'animate-[slideIn_0.5s_forwards]' : ''}`} 
      onClick={handleNext}
    >
      {onClose && (
        <button 
      ...
      {page === 0 ? (
        <div className="flex flex-col animate-[fadeIn_0.3s_ease-in]">
          ...
          <p className="text-[#9295a3] text-[15px] leading-[1.5] mb-[35px] min-h-[45px]">
          ...
          <div className="flex justify-between bg-[#1a1b1f] rounded-[20px] py-5 px-2.5 shadow-[inset_8px_8px_16px_rgba(0,0,0,0.4),inset_-8px_-8px_16px_rgba(255,255,255,0.02)]">
            <div className="flex flex-col items-center w-[30%]">
              ...
              <div className="text-[20px] font-[800] mb-[5px] text-white">
            ...
            <div className="w-[1px] bg-[rgba(255,255,255,0.03)]" />
            <div className="flex flex-col items-center w-[30%]">
        ...
        <div className="flex flex-col animate-[fadeIn_0.3s_ease-in]">
          ...
          <div className="flex flex-col items-stretch gap-[15px] mt-5 bg-[#1a1b1f] rounded-[20px] py-5 px-2.5 shadow-[inset_8px_8px_16px_rgba(0,0,0,0.4),inset_-8px_-8px_16px_rgba(255,255,255,0.02)]">
             ...
             <div className="w-full h-[1px] bg-[rgba(255,255,255,0.03)]" />
             <div className="flex justify-between px-[10px]">
